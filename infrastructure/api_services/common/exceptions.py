...
class ResourceNotFound(HTTPException, details=None):
    resource_name = "Resource"

    def __init__(self, resource_id: UUID | int, details: str = None) -> None:
        super().__init__(
            status_code=HTTPStatus.NOT_FOUND,
            detail=details or f"{self.resource_name} {resource_id} was not found"
        )
