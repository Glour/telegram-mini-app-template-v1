...
from settings.app_settings import AppSettings, get_app_settings
...
def register_global_middlewares(
    ...
    :param repo: The RequestsRepo instance.
    :return: None
    """
    bot_middleware = [
        ConfigMiddleware(settings, apscheduler, repo),
        DatabaseMiddleware(repo),
...
async def main():
    ...
    register_global_middlewares(dp, settings, repo, i18n, scheduler)
